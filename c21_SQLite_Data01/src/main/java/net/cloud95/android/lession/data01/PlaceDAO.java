...
public class PlaceDAO {
   ...
   public Place insert(Place place) {
      ...
      long id = db.insert(TABLE_NAME, null, cv); // ★★ @return the row ID of the newly inserted row, or -1 if an error occurred
      // 設定編號
      place.setId(id);
      // 回傳結果
      return place;
   ...
   public boolean update(Place place) {
      ...
      return db.update(TABLE_NAME, cv, where, null) > 0; // ★★ @return the number of rows affected...............
   }
   ...
   // 取得參數指定日期資料的Cursor物件
   // 選擇日期的Dialog中，選定日期後按下確定按鈕時，所要執行的程式區塊 ..................................
   // 它比起 getAllCursor來說，多了一個參數，就是 where ..............................................
   ...
   public Place get(long id) {
      ...
      String where = KEY_ID + "=" + id;
      // 執行查詢
      Cursor result = db.query(TABLE_NAME, COLUMNS, where, null, null, null, null, null);
      // 如果有查詢結果
